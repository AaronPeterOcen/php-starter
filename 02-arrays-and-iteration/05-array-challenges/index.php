...
echo '<h3>Sum Of An Array</h3>'. array_sum($num);
...
/*
  ...
  1. Create a multi-dimensional array of associative arrays of 3 job listings with the fields id, job_title, company, contact_email, 
  and contact_phone. Also add an array field for skills. The skills array should be an array of strings with each skill a person has. For example, 'PHP', 'MySQL', 'JavaScript', 'HTML', 'CSS', etc.
...
$jobs = [
  [
    ...
    'company' => 'fiver', 
    'contact_email' => 'oen@mail.com', 
    'contact_phone' => '12-0000-000', 
    ...
    'company' => 'torrs', 
    'contact_email' => 'qwerty@mail.com', 
    'contact_phone' => '12-0000-001', 
    'skills'=> ['Photoshop', 'Illustrator', 'HTML', 'CSS']
  ],  [
    'id' => '12342', 
    'job_title' => 'technical', 
    'company' => 'forb3', 
    'contact_email' => 'rety@mail.com', 
    'contact_phone' => '12-0000-001', 
